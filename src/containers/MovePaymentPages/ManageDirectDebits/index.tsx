...
import RightTable from '../../../components/MovePaymentComponents/ManageDirectDebitsComponents/RightTable'
import ActivityDetection from '../../../components/ActivityDetection'
// import { useTranslation } from 'react-i18next'
import '../ApproveTransactions/styles.scss'

interface IManageDirectDebitsProps {
...
const ManageDirectDebits: React.FunctionComponent<IManageDirectDebitsProps> = (props) => {
  ...
  useEffect(() => {
    ...
    nprogress.start()
    props.dataAction.getMovePaymentManageDirectDebitsData()
  }, [props.dataAction])
  ...
  const { dataList } = { ...props.movePaymentManageDirectDebits }
  ...
  return (
    <React.Fragment>
      ...
      {!!dataList && (
        <div className="content manage-direct-debits-content">
          <div className="mains">
            <ActivityDetection />
...
export default connect(mapStateToProps, matchDispatchToProps)(ManageDirectDebits)

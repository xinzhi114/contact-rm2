...
import HomeMainBanner, { HomeMainBanner as HomeMainBannerComponent } from '../index'
...
describe('ManageAlerts component testing', () => {
  ...
  beforeEach(async () => {
    ...
    component = wrapper.find(HomeMainBannerComponent).instance() as HomeMainBannerComponent
  })

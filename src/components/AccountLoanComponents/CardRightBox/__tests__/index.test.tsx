...
import CardRightBox, { CardRightBox as CardRightBoxComponent } from '../index'
import {
  AppContainer,
  nextScreen,
  beforeEachHelper,
...
describe('CardRightBox component testing', () => {
  let wrapper: WrapperType
  let component: CardRightBoxComponent
  let props
  const createWrapper = async (extraProps = {}) => {
    ...
    component = wrapper.find(CardRightBoxComponent).instance() as CardRightBoxComponent
  }
